...
Loaded 101 tensors, 8652672 parameters, in 0.032s. Config: d_model 256, d_ff 1024, 4 heads × d_kv 64, 4+4 layers, patch 16, context 2048, horizon 64, 9 quantiles, REG token true.
...
|---|---|---|---|---|---|---|---|---|---|---|---|
| peyton | 2905 | 129 | 9.5e-7 | 1.8e-7 | 6.0e-7 / 3.6e-7 / 0.0e0 | 1.4e-6 / 5.2e-7 | 5.0e-6 | **9.54e-7** | 0.0001% | 36.3 | 5.9 |
| air | 144 | 10 | 0.0e0 | 1.5e-5 | 3.3e-7 / 4.5e-7 / 0.0e0 | 5.7e-7 / 2.7e-7 | 2.0e-6 | **1.83e-4** | 0.0002% | 2.9 | 2.6 |
...
- max abs diff: first 64 steps 9.54e-7, all 365 steps **1.72e-5**, steps 300–365 1.72e-5 (y range ≈ 7.6); Rust 1671 ms vs torch 81 ms
...
|---|---|---|---|---|
| plain Rust loops, 8-accumulator dot | 36.4 | 9.5e-7 | 1671 | 1.7e-5 |
| trueno `blis::gemm_blis` packed GEMM, weights pre-transposed | **21.0** | 9.5e-7 | **967** | 1.7e-5 |
...
| one 256→256 projection | 0.50 | 0.26 |
| self-attention (4 projections + scores + context) | 2.81 | 1.79 |
| FF wi 256→1024 | 1.98 | 1.02 |
| FF wo 1024→256 | 2.37 | 1.01 |
| full encoder (4 layers) | 29.14 | 15.87 |
